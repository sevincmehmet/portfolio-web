...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-[#0A0A0F] border-t border-white/5 overflow-hidden selection:bg-amber-500/30">
      <AnimatePresence mode="wait">
        {/* =========================================
             TASARIM 1: VİZYON (EDİTÖRYAL FİNAL)
             ========================================= */}
        {viewMode === "vizyon" && (
          <motion.div
            key="v-footer"
        ...
        {/* =========================================
             TASARIM 2: BENTO (SİSTEMATİK KUTULAR)
             ========================================= */}
        {viewMode === "bento" && (
          <motion.div
            key="b-footer"
            ...
            exit={{ opacity: 0, y: -20 }}
            transition={transition}
            className="max-w-[75rem] mx-auto px-6 py-12 relative z-10"
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* Marka Kutusu */}
              <div className="p-8 bg-white/[0.02] border border-white/5 rounded-[2rem] backdrop-blur-xl flex flex-col justify-between">
              ...
              {/* Lokasyon Kutusu */}
              <div className="p-8 bg-[#111111]/40 border border-white/5 rounded-[2rem] flex flex-col justify-between group hover:border-amber-500/20 transition-colors">
        ...
        {/* =========================================
             TASARIM 3: ZEN (ULTRA-MİNİMAL SON)
             ========================================= */}
        {viewMode === "zen" && (
          <motion.div
            key="z-footer"
            ...
            <div className="space-y-10">
              <div className="flex justify-center">
                <motion.div
                  ...
                  className="w-12 h-12 border border-white/5 rounded-full flex items-center justify-center"
                >
      ...
      {/* Arka Plan Dekoratif Işık (Footer'a derinlik katar) */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[200px] bg-amber-500/[0.02] blur-[100px] rounded-full pointer-events-none"></div>
    </footer>
  );
};
